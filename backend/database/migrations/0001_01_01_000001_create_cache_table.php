...
return new class extends Migration
{
     ...
     * As tabelas cache e cache_locks são tabelas de sistema do Laravel
     * para cache e não são necessárias para o teste da SignoTech.
     * 
    ...
    {
        // As tabelas cache e cache_locks foram removidas
